...
class _LoginWidgetState extends State<LoginWidget>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: scaffoldKey,
      backgroundColor: const Color(0xFFF6292F),
      body: Stack(
        children: [
          Container(
            ...
            child: Opacity(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(24.0, 64.0, 24.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'e95mrig0' /* Logueate para iniciar */,
                                  ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '2oy1zcol' /* Access your account below or */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      ...
                                      text: FFLocalizations.of(context).getText(
                                        '108wmpte' /* ¿Has olvidado tu contraseña? */,
                                      ),
                                      options: FFButtonOptions(
                                        width: 170.0,
                                        height: 50.0,
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      'i93dtx6p' /* Continuar como Invitado */,
                                    ),
                                    options: FFButtonOptions(
                                      width: 200.0,
                                      height: 40.0,
