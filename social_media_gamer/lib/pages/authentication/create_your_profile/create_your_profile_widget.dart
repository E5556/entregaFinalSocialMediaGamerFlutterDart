                    ...
                    children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '4ntxts9x' /* Completa tu perfil ahora para ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                      ...
                      if (responsiveVisibility(
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'fvxwu4km' /* Completa tu perfil ahora para ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: FFLocalizations.of(context).getText(
                              '8kd34wwu' /* Completar Configuracion */,
                            ),
